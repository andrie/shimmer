...
The underlying infrastructure of the simulation is provided by the `simmer` package (for discrete event simulations). In other words, `shimmer` simulates Shiny app scaling using the `simmer` simulation framework.
